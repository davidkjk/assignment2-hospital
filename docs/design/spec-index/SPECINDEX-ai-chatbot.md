...
| 오늘/캘린더/패널 | `TODAY-RESCHED-23~28`, `SUPPORT-TODAY-*`, `SUPPORT-CAL-*`, `SUPPORT-PANEL-*` | 독립 취소/변경 수치카드 대신 `/today`의 “확인 필요한 예약” 환자별 행에 상담·변경 상태를 통합한다. 캘린더 ⚠와 기존 패널이 예약 처리를 담당하며, 티켓함은 전체 대화용이다. 선택한 ticket/calendar context를 양방향 복원한다. | G-01, G-02 | `docs/design/screen-behaviors.md:539-544,5417-5478`; `HANDOFF.md:156`; D4 `docs/superpowers/specs/2026-07-31-ui-design-decisions.md:5032-5072` |
