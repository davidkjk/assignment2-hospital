...
insert into patients (id, name, birth_date, gender, phone, is_active, auth_user_id) values
  ...
  ('dede0000-0000-0000-0000-0000000000f4', '김정호', '1958-01-15', 'M', '010-1234-5670', true, null),  -- 아버지
  ('dede0000-0000-0000-0000-0000000000f5', '박영자', '1960-09-03', 'F', '010-1234-5671', true, null);  -- 어머니
