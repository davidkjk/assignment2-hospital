...
function DoctorDayCalendar({ pickable }: { pickable: boolean }) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      />
      <div className="mb-3 flex items-center justify-between rounded-xl border border-border/70 bg-card px-4 py-2.5 shadow-[0_1px_2px_rgba(16,45,50,0.04)]">
      ...
      <div className="overflow-y-auto rounded-xl border border-border/70 bg-card p-3 shadow-[0_1px_2px_rgba(16,45,50,0.04)]" style={{ maxHeight: 'calc(100vh - 20rem)' }}>
            ...
            {blocks.map((b, i) => {
              ...
              return (
                <div key={i} className="pointer-events-none absolute inset-x-1 overflow-hidden rounded-md px-2 py-0.5"
                  style={{ top, height: h, background: d.fill, color: d.ink, boxShadow: '0 1px 0 #fff' }}>
...
function PatientDetailSurface() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-3 rounded-xl border border-border/70 bg-card p-4 text-sm shadow-[0_1px_2px_rgba(16,45,50,0.04)]">
