...
// 요구사항 원문(line 13): 의사 5~8명 · 하루 외래 100명 안팎 → 의사 6명(진료과 4곳).
...
// 의사 6명 · 진료과 4곳 (내과 2 · 정형외과 2 · 이비인후과 1 · 가정의학과 1)
...
export const calendarOffHours: OffHours[] = [
  ...
  { doctorId: 'd6', start: '12:00', end: '13:00', kind: '점심시간' },
]
...
export const calendarAppointments: CalendarAppointment[] = [
  ...
  { id: 'a6', doctorId: 'd1', patientName: '서동일', patientBirth: '1960-03-25', phone: '010-6612-7788', start: '11:30', end: '11:45', status: '도착', reason: '혈압 상담' },
  ...
  { id: 'b4', doctorId: 'd2', patientName: '정미경', patientBirth: '1987-06-18', phone: '010-7788-3320', start: '10:40', end: '11:00', status: '예약신청', reason: '갑상선 재검' },
  { id: 'b5', doctorId: 'd2', patientName: '한명숙', patientBirth: '1963-01-08', phone: '010-3390-4471', start: '11:20', end: '11:40', status: '예약확정', reason: '위염 재진' },
  ...
  { id: 'c4', doctorId: 'd3', patientName: '임철수', patientBirth: '1970-07-02', phone: '010-2245-6690', start: '11:40', end: '12:00', status: '예약신청', reason: '허리 통증' },
  ...
  { id: 'e4', doctorId: 'd4', patientName: '남기훈', patientBirth: '1966-02-14', phone: '010-9980-5567', start: '11:20', end: '11:40', status: '예약신청', reason: '어깨 재진' },
  ...
  { id: 'g4', doctorId: 'd6', patientName: '박준서', patientBirth: '1997-01-21', phone: '010-3390-5567', start: '10:45', end: '11:00', status: '예약신청', reason: '금연 상담' },
  { id: 'g5', doctorId: 'd6', patientName: '최성실', patientBirth: '1958-09-13', phone: '010-7788-1120', start: '11:30', end: '11:45', status: '예약확정', reason: '영양 상담' },
]
