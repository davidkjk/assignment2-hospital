...
const styles: Record<string, CSSProperties> = {
  ...
  when: { fontSize: 'var(--fs-base)', fontWeight: 700, color: 'var(--color-ink)', fontVariantNumeric: 'tabular-nums', minWidth: 92 },
  ...
  status: { marginLeft: 'auto', fontSize: 'var(--fs-sm)', fontWeight: 700, color: 'var(--color-ink-muted)' },
  more: {
    marginTop: 12, height: 32, padding: '0 14px', borderRadius: 8,
    border: '1px solid var(--color-divider)', background: 'var(--color-surface)',
    color: 'var(--color-primary)', fontSize: 'var(--fs-sm)', fontWeight: 600, cursor: 'pointer',
  },
}
