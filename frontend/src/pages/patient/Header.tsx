...
const styles: Record<string, CSSProperties> = {
  ...
  name: { fontSize: 'var(--fs-xl)', fontWeight: 800, color: 'var(--color-ink)' },
  relationChip: {
  ...
  meta: { display: 'flex', gap: 10, fontSize: 'var(--fs-base)', color: 'var(--color-ink-muted)', fontVariantNumeric: 'tabular-nums' },
  metaItem: {},
  contact: { display: 'flex', flexDirection: 'column', gap: 6, minWidth: 0 },
  phoneRow: { display: 'flex', alignItems: 'center', gap: 8 },
  phone: { fontSize: 'var(--fs-lg)', fontWeight: 700, color: 'var(--color-ink)', fontVariantNumeric: 'tabular-nums' },
  copyBtn: {
  ...
  deadRow: { display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' },
  deadText: { fontSize: 'var(--fs-sm)', fontWeight: 700, color: 'var(--color-warn)' },
  deadTime: { fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)', fontVariantNumeric: 'tabular-nums' },
  fixBtn: {
    height: 26, padding: '0 10px', borderRadius: 6, border: '1px solid var(--color-warn)',
    background: 'var(--color-surface)', color: 'var(--color-warn)', fontSize: 'var(--fs-sm)', fontWeight: 700, cursor: 'pointer',
  },
  roleChip: {
    marginLeft: 'auto', fontSize: 'var(--fs-sm)', fontWeight: 700, color: 'var(--color-ink-muted)',
    background: 'var(--color-bg)', border: '1px solid var(--color-divider)', borderRadius: 6, padding: '2px 8px',
  },
}
