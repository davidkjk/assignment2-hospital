...
const styles: Record<string, CSSProperties> = {
  ...
  preserveTitle: { margin: '0 0 8px', fontSize: 'var(--fs-base)', fontWeight: 700, color: 'var(--color-ink)' },
  preserveList: { margin: 0, paddingLeft: 18, display: 'flex', flexDirection: 'column', gap: 4, fontSize: 'var(--fs-base)', color: 'var(--color-ink)' },
  lineage: { margin: '10px 0 0', fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
  actionRow: { display: 'flex', alignItems: 'center', gap: 12 },
  reasonHint: { margin: 0, fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
  primaryBtn: { height: 36, padding: '0 18px', borderRadius: 8, border: 'none', background: 'var(--color-primary)', color: '#fff', fontSize: 'var(--fs-base)', fontWeight: 700, cursor: 'pointer' },
  primaryBtnOff: { height: 36, padding: '0 18px', borderRadius: 8, border: 'none', background: 'var(--color-sidebar-ink)', color: '#fff', fontSize: 'var(--fs-base)', fontWeight: 700, opacity: 0.5, cursor: 'not-allowed' },
  doneTitle: { margin: '0 0 8px', fontSize: 'var(--fs-xl)', fontWeight: 700, color: 'var(--color-ink)' },
  doneNote: { margin: '0 0 14px', fontSize: 'var(--fs-base)', color: 'var(--color-ink-muted)', lineHeight: 1.5 },
  doneAudit: { margin: '12px 0 16px', fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
}
