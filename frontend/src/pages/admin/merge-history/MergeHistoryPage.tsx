...
const styles: Record<string, CSSProperties> = {
  ...
  title: { margin: '0 0 4px', fontSize: 'var(--fs-title)', color: 'var(--color-ink)' },
  desc: { margin: '0 0 14px', fontSize: 'var(--fs-body)', color: 'var(--color-ink-muted)' },
  offline: {
  ...
  row: {
    display: 'grid', gridTemplateColumns: '160px 90px 1fr 92px 96px', gap: 12, alignItems: 'center',
    padding: '10px 14px', borderTop: '1px solid var(--color-divider)', fontSize: 'var(--fs-body)', color: 'var(--color-ink)',
  },
  ...
  badge: { justifySelf: 'start', padding: '2px 9px', borderRadius: 999, fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], whiteSpace: 'nowrap' },
  detailBtn: {
