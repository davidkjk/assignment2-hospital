...
const styles: Record<string, CSSProperties> = {
  page: { padding: 'var(--sp-5)', maxWidth: 960, margin: '0 auto' },
  ...
  skeleton: { height: 52, borderRadius: 'var(--radius-card)', marginBottom: 'var(--sp-3)', background: 'var(--color-divider)', opacity: 0.55 },
  ...
  headRow: {
    display: 'grid', gridTemplateColumns: '160px 90px 1fr 92px 96px', gap: 'var(--sp-3)', alignItems: 'center',
    padding: 'var(--sp-2) var(--sp-4)', background: 'var(--color-bg)', color: 'var(--color-ink-muted)',
    fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], borderBottom: '1px solid var(--color-divider)',
  },
  row: {
    display: 'grid', gridTemplateColumns: '160px 90px 1fr 92px 96px', gap: 'var(--sp-3)', alignItems: 'center',
    padding: 'var(--sp-3) var(--sp-4)', borderTop: '1px solid var(--color-divider)', fontSize: 'var(--fs-body)', color: 'var(--color-ink)',
  },
  when: { fontVariantNumeric: 'tabular-nums', color: 'var(--color-ink-muted)' },
  who: { fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  parties: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', minWidth: 0 },
  arrow: { color: 'var(--color-ink-muted)' },
  pid: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)', fontVariantNumeric: 'tabular-nums', fontFamily: 'monospace' },
  badge: { justifySelf: 'start', padding: 'var(--sp-0-5) var(--sp-2)', borderRadius: 999, fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], whiteSpace: 'nowrap' },
  detailBtn: {
    height: 30, padding: '0 var(--sp-3)', borderRadius: 8, border: '1px solid var(--color-divider)',
    background: 'var(--color-surface)', color: 'var(--color-ink)', fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], cursor: 'pointer',
  },
  zeroAction: {
  ...
  more: {
    alignSelf: 'center', margin: 'var(--sp-3)', height: 34, padding: '0 var(--sp-4)', borderRadius: 8,
