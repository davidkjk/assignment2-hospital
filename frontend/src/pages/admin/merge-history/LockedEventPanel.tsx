...
const styles: Record<string, CSSProperties> = {
  ...
  reason: { margin: '8px 0 0', fontSize: 'var(--fs-base)', color: 'var(--color-ink)', lineHeight: 1.5 },
  actions: { display: 'flex', gap: 8, marginTop: 14 },
  exitBtn: { height: 34, padding: '0 14px', borderRadius: 8, border: '1px solid var(--color-primary)', background: 'var(--color-surface)', color: 'var(--color-primary)', fontSize: 'var(--fs-base)', fontWeight: 700, cursor: 'pointer' },
  ...
  memoHint: { fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
  savedNote: { margin: '12px 0 0', fontSize: 'var(--fs-base)', color: 'var(--color-done)', fontWeight: 600 },
}
