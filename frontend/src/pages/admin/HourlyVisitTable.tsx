...
const styles: Record<string, CSSProperties> = {
  ...
  basis: { fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
  list: { listStyle: 'none', margin: '12px 0 0', padding: 0, display: 'flex', flexDirection: 'column', gap: 6 },
  row: { display: 'flex', alignItems: 'center', gap: 10, fontSize: 'var(--fs-base)' },
