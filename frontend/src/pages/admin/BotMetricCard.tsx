...
const styles: Record<string, CSSProperties> = {
  ...
  note: { margin: 'var(--sp-0-5) 0 0', fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  list: { margin: 'var(--sp-3) 0 0', display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' },
  row: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 'var(--fs-body)' },
  ...
  ddMuted: { fontWeight: 'var(--fw-caption)' as CSSProperties['fontWeight'], fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  foot: { margin: 'var(--sp-3) 0 0', fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
}
