...
const styles: Record<string, CSSProperties> = {
  wrap: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)', maxWidth: 920 },
  actionBar: {
    display: 'flex',
    alignItems: 'center',
    gap: 'var(--sp-3)',
  ...
  unsaved: { marginRight: 'var(--sp-1)', fontSize: 'var(--fs-caption)', color: 'var(--color-warn)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  saveError: { margin: 0, fontSize: 'var(--fs-body)', color: 'var(--color-warn)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  flash: { margin: 0, padding: 'var(--sp-2) var(--sp-3)', borderRadius: 8, borderLeft: '4px solid var(--color-primary)', background: 'var(--color-primary-wash)', fontSize: 'var(--fs-body)', color: 'var(--color-ink)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  pageHead: { marginBottom: 'var(--sp-1)' },
  ...
  menu: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)', width: 235, flex: '0 0 235px' },
  colLabel: { margin: '0 0 var(--sp-2)', fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], letterSpacing: '.04em', textTransform: 'uppercase', color: 'var(--color-ink-muted)' },
  menuItem: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 'var(--sp-0-5)', width: '100%', textAlign: 'left', padding: 'var(--sp-3) var(--sp-3)', borderRadius: 'var(--radius-card)', border: '1px solid var(--color-divider)', background: 'var(--color-surface)', boxShadow: 'var(--shadow-card)', cursor: 'pointer', color: 'var(--color-ink)' },
  ...
  panel: { flex: 1, minWidth: 0, background: 'var(--color-surface)', border: '1px solid var(--color-divider)', borderRadius: 'var(--radius-card, 8px)', padding: 'var(--sp-6)' },
}
