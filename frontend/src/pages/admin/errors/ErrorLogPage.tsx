...
const styles: Record<string, CSSProperties> = {
  ...
  readonlyTitle: { fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  readonlyBody: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)', lineHeight: 1.5 },
  boundary: {
    display: 'flex',
    alignItems: 'flex-start',
    gap: 'var(--sp-2)',
  ...
  boundaryIcon: { color: 'var(--color-ink-muted)', flexShrink: 0, marginTop: 'var(--sp-0-5)' },
  strong: { fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  filterCard: {
    padding: 'var(--sp-3) var(--sp-4)',
    borderRadius: 10,
    border: '1px solid var(--color-divider)',
  ...
  filterBar: { display: 'flex', alignItems: 'flex-end', gap: 'var(--sp-3)', flexWrap: 'wrap' },
  scope: { marginLeft: 'auto', paddingBottom: 'var(--sp-1)', fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], color: 'var(--color-ink-muted)' },
  tableCard: {
    borderRadius: 10,
    border: '1px solid var(--color-divider)',
    background: 'var(--color-surface)',
  ...
  td: { padding: 'var(--sp-3) var(--sp-4)', color: 'var(--color-ink)', verticalAlign: 'top' },
  summaryRow: { display: 'flex', alignItems: 'flex-start', gap: 'var(--sp-2)' },
  outageIcon: { color: 'var(--color-warn)', flexShrink: 0, marginTop: 'var(--sp-0-5)' },
  normalIcon: { color: 'var(--color-ink-muted)', flexShrink: 0, marginTop: 'var(--sp-0-5)' },
  summaryText: { display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 'var(--sp-2)' },
  outageBadge: {
    display: 'inline-flex',
    alignItems: 'center',
    gap: 'var(--sp-1)',
  ...
  loadingText: { margin: 'var(--sp-2) 0 0', fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  zeroHint: { margin: 0, fontSize: 'var(--fs-body)', color: 'var(--color-ink-muted)' },
