...
const styles: Record<string, CSSProperties> = {
  ...
  value: { fontSize: 'var(--fs-num)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], lineHeight: 1.1, color: 'var(--color-ink)', fontVariantNumeric: 'tabular-nums' },
  unit: { marginLeft: 'var(--sp-0-5)', fontSize: 'var(--fs-body)', fontWeight: 'var(--fw-caption)' as CSSProperties['fontWeight'], color: 'var(--color-ink-muted)' },
  basis: { marginTop: 'var(--sp-0-5)', fontSize: 'var(--fs-caption)', color: 'var(--color-gray-past)' },
  drillBtn: {
    marginTop: 'auto',
    paddingTop: 0,
