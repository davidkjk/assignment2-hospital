          ...
          return (
            ...
            >
              <input
                ...
                style={styles.radio}
              />
              {/* [CAL-COLOR-12] 칩 자체가 캘린더에서 보일 면 색(배경). 안쪽 strong 막대(띠)는 두지 않는다
                  — strong 색이 어두운 팔레트에선 「검정 네모」처럼 보여 무엇인지 헷갈린다는 지적(사용자
                  결정 2026-09-01). 「사용중」 표시만 남기고, 칩 폭은 고정해 붙어도 안 붙어도 정렬 유지(L27). */}
