...
const styles: Record<string, CSSProperties> = {
  ...
  lede: { margin: '2px 0 0', fontSize: 'var(--fs-base)', color: 'var(--color-ink-muted)' },
  csvBtn: {
    height: 34,
    padding: '0 14px',
  ...
  exportNote: { margin: 0, color: 'var(--color-warn)', fontSize: 'var(--fs-base)', fontWeight: 600 },
  ...
  csvNote: { margin: 0, fontSize: 'var(--fs-base)', color: 'var(--color-ink)' },
  csvAudit: { margin: '8px 0 0', fontSize: 'var(--fs-sm)', color: 'var(--color-ink-muted)' },
}
