...
const styles: Record<string, CSSProperties> = {
  ...
  lede: { margin: 'var(--sp-0-5) 0 0', fontSize: 'var(--fs-body)', color: 'var(--color-ink-muted)' },
  csvBtn: {
    height: 34,
    padding: '0 var(--sp-4)',
    border: '1px solid var(--color-divider)',
  ...
  csvAudit: { margin: 'var(--sp-2) 0 0', fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
}
