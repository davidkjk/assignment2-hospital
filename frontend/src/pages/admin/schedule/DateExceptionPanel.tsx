...
const styles: Record<string, CSSProperties> = {
  wrap: { display: 'flex', gap: 'var(--sp-4)', alignItems: 'flex-start' },
  calendar: { flex: '0 0 260px', border: '1px solid var(--color-divider)', borderRadius: 'var(--radius-card)', padding: 'var(--sp-3)', background: 'var(--color-surface)' },
  calHead: { fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], fontSize: 'var(--fs-body)', marginBottom: 'var(--sp-2)', color: 'var(--color-ink)' },
  calGrid: { display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 'var(--sp-0-5)' },
  calDay: {
    position: 'relative',
    aspectRatio: '1',
    border: 'none',
  ...
  rightHead: { margin: '0 0 var(--sp-3)', fontSize: 'var(--fs-section)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  entryList: { listStyle: 'none', margin: '0 0 var(--sp-3)', padding: 0, display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' },
  entry: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 'var(--sp-2)', padding: 'var(--sp-2) var(--sp-3)', border: '1px solid var(--color-divider)', borderRadius: 8, fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
  entryMeta: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  field: { border: '1px solid var(--color-divider)', borderRadius: 8, padding: 'var(--sp-4)', marginBottom: 'var(--sp-3)', display: 'flex', flexWrap: 'wrap', gap: 'var(--sp-4)' },
  legend: { fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], color: 'var(--color-ink-muted)', padding: '0 var(--sp-1)' },
  memoRow: { display: 'flex', alignItems: 'center', gap: 'var(--sp-3)', marginBottom: 'var(--sp-3)', fontSize: 'var(--fs-body)' },
