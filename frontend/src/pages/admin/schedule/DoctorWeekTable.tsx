...
const styles: Record<string, CSSProperties> = {
  ...
  tdLabel: { padding: '5px 8px', borderBottom: '1px solid var(--color-divider)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], whiteSpace: 'nowrap' },
  ...
  warnHead: { margin: '0 0 4px', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
  warnList: { margin: 0, paddingLeft: 18, fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
  slotNote: { margin: '4px 0 0', fontSize: 'var(--fs-body)', color: 'var(--color-warn)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
}
