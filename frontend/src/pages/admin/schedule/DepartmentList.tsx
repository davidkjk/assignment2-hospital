...
const styles: Record<string, CSSProperties> = {
  ...
  rowMain: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-0-5)' },
  ...
  blockMsg: { margin: '0 0 var(--sp-2)', fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
  blockList: { margin: '0 0 var(--sp-2)', paddingLeft: 'var(--sp-5)', fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
  blockHint: { margin: 0, fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  actionError: { margin: 'var(--sp-3) 0 0', fontSize: 'var(--fs-caption)', color: 'var(--color-danger)' },
}
