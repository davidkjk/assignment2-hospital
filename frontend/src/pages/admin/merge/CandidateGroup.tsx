...
const styles: Record<string, CSSProperties> = {
  ...
  head: { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 'var(--sp-2)' },
  title: { margin: 0, fontSize: 'var(--fs-section)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  count: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  caution: { margin: 'var(--sp-2) 0 var(--sp-3)', fontSize: 'var(--fs-caption)', color: 'var(--color-warn)', lineHeight: 1.5 },
  rows: { listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' },
  row: {
    padding: 'var(--sp-3)',
    borderRadius: 8,
    border: '1px solid var(--color-divider)',
  ...
  rowMain: { display: 'flex', alignItems: 'center', gap: 'var(--sp-3)', flexWrap: 'wrap' },
  ...
  rowFoot: { display: 'flex', alignItems: 'center', gap: 'var(--sp-3)', marginTop: 'var(--sp-2)' },
  counts: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)', fontVariantNumeric: 'tabular-nums' },
  cardFoot: { display: 'flex', justifyContent: 'flex-end', marginTop: 'var(--sp-3)' },
  reviewBtn: {
    height: 32,
    padding: '0 var(--sp-4)',
    borderRadius: 8,
