...
const styles: Record<string, CSSProperties> = {
  ...
  heading: { fontSize: 18, fontWeight: 700, margin: '0 0 20px' },
  ...
  resetLink: { display: 'block', marginTop: 14, textAlign: 'center', color: 'var(--color-primary)', fontWeight: 600, fontSize: 13 },
}
