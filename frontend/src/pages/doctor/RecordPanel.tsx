...
const styles: Record<string, CSSProperties> = {
  ...
  headRow: { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 'var(--sp-2)' },
  heading: { margin: 0, fontSize: 'var(--fs-section)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  draftStatus: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)', fontVariantNumeric: 'tabular-nums' },
  completedTag: { fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-done)' },
  alertRow: { display: 'flex', alignItems: 'center', gap: 'var(--sp-3)', borderLeft: '4px solid var(--color-warn)', paddingLeft: 'var(--sp-3)' },
  alertText: { color: 'var(--color-warn)', fontSize: 'var(--fs-body)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  retryBtn: {
    height: 28, padding: '0 var(--sp-3)', borderRadius: 6, border: '1px solid var(--color-warn)',
  ...
  fieldset: { margin: 0, padding: 'var(--sp-3)', border: '1px solid var(--color-divider)', borderRadius: 'var(--radius-card)' },
  legend: { padding: '0 var(--sp-2)', fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-ink-muted)' },
  publicNote: { margin: '0 0 var(--sp-2)', fontSize: 'var(--fs-caption)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-primary)' },
  field: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-1)', marginBottom: 'var(--sp-2)' },
  ...
  textarea: {
    ...
    color: 'var(--color-ink)', fontSize: 'var(--fs-section)', fontFamily: 'inherit', resize: 'vertical',
  },
  readonly: { background: 'var(--color-bg)', color: 'var(--color-ink)' },
  resumeHint: { margin: 0, fontSize: 'var(--fs-body)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], color: 'var(--color-warn)' },
  actions: { display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 'var(--sp-2)' },
  offlineReason: { marginRight: 'auto', fontSize: 'var(--fs-caption)', color: 'var(--color-danger)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'] },
  ghostBtn: {
    height: 30, padding: '0 var(--sp-3)', borderRadius: 8, border: '1px solid var(--color-divider)',
  ...
  reviseForm: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' },
  reasonInput: {
    width: '100%', boxSizing: 'border-box', height: 34, padding: '0 var(--sp-3)', borderRadius: 8,
    border: '1px solid var(--color-divider)', background: 'var(--color-surface)', color: 'var(--color-ink)', fontSize: 'var(--fs-body)',
  },
  prevBox: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)', padding: 'var(--sp-3)', background: 'var(--color-bg)', borderRadius: 8 },
  prevItem: { display: 'flex', flexDirection: 'column', gap: 'var(--sp-0-5)' },
  prevMeta: { margin: 0, fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  prevLine: { margin: 0, fontSize: 'var(--fs-body)', color: 'var(--color-ink)' },
}
