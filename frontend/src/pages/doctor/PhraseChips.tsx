...
const styles: Record<string, CSSProperties> = {
  ...
  chips: { display: 'flex', flexWrap: 'wrap', gap: 'var(--sp-2)', alignItems: 'center' },
  chipWrap: { position: 'relative', display: 'inline-flex' },
  lockNote: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)', width: '100%' },
  chip: {
    height: 26, padding: '0 var(--sp-3)', borderRadius: 999, border: '1px solid var(--color-primary)',
  ...
  tooltip: {
    position: 'absolute', bottom: '100%', left: 0, zIndex: 20, marginBottom: 'var(--sp-1)', maxWidth: 280,
    padding: 'var(--sp-2) var(--sp-2)', borderRadius: 6, background: 'var(--color-ink)', color: '#fff', fontSize: 'var(--fs-caption)', lineHeight: 1.4,
  },
  stateRow: { display: 'flex', alignItems: 'center', gap: 'var(--sp-2)' },
  stateText: { fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  retry: {
    height: 26, padding: '0 var(--sp-3)', borderRadius: 6, border: '1px solid var(--color-primary)',
  ...
  manageBtn: {
    height: 24, padding: '0 var(--sp-2)', borderRadius: 6, border: 'none', background: 'transparent',
