    ...
    <div data-testid="pick-bar" data-component="PickBar" role="toolbar" aria-label="선택 동작" style={styles.bar}>
      ...
      {canOfferAll && (
        <div style={styles.allRow} role="note">
          ...
          <button type="button" onClick={onSelectAllMatching} style={styles.linkBtn}>
      ...
      {allMatching && (
        ...
        <div style={styles.warnRow} role="alert">
          ...
          <button type="button" onClick={onSelectVisibleOnly} style={styles.linkBtn}>
...
const styles: Record<string, CSSProperties> = {
  ...
  linkBtn: {
    ...
    fontSize: 'var(--fs-sm)', fontWeight: 700, cursor: 'pointer', textDecoration: 'underline', padding: 0,
  },
}
