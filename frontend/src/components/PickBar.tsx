...
const styles: Record<string, CSSProperties> = {
  ...
  count: { fontSize: 'var(--fs-body)', fontWeight: 'var(--fw-title)' as CSSProperties['fontWeight'], color: 'var(--color-ink)' },
  actions: { display: 'flex', gap: 'var(--sp-2)', marginLeft: 'auto' },
  statusBtn: {
    height: 30, padding: '0 var(--sp-3)', borderRadius: 6, border: 'none',
  ...
  primary: {
    height: 30, padding: '0 var(--sp-3)', borderRadius: 6, border: '1px solid var(--color-primary)',
  ...
  ghost: {
    height: 30, padding: '0 var(--sp-3)', borderRadius: 6, border: '1px solid var(--color-divider)',
  ...
  note: { flexBasis: '100%', margin: 0, fontSize: 'var(--fs-caption)', color: 'var(--color-ink-muted)' },
  allRow: { flexBasis: '100%', display: 'flex', alignItems: 'center', gap: 'var(--sp-2)', fontSize: 'var(--fs-caption)' },
  allText: { color: 'var(--color-ink-muted)' },
  warnRow: {
    flexBasis: '100%', display: 'flex', alignItems: 'center', gap: 'var(--sp-2)',
    padding: 'var(--sp-2) var(--sp-2)', borderRadius: 6, background: 'var(--color-danger-bg)', border: '1px solid var(--color-warn)',
  },
  warnText: { color: 'var(--color-warn)', fontWeight: 'var(--fw-section)' as CSSProperties['fontWeight'], fontSize: 'var(--fs-caption)' },
}
