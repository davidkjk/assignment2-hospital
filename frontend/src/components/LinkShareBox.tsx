...
// [STAFF-INVITE-LINK-01·STAFF-REINVITE-LINK-01·STAFF-RESETPW-LINK-01] 관리자가 직접 전달할
// '비밀번호 설정/재설정' 링크를 화면에 노출하는 공용 상자. 발신 도메인 미검증이라 메일을 자동
// 발송하지 않으므로(2026-09-07), 초대·재초대·비번재설정 세 곳이 같은 상자로 링크를 보여 준다.
