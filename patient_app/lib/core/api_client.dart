...
class ApiException implements Exception {
  ApiException(this.message, {this.statusCode, this.context}); // statusCode 추가(T0 누락 보강)
...
class ApiClient {
  ...
  T _handle<T>(http.Response response, T Function(dynamic) parse) {
    ...
    throw ApiException(message, statusCode: response.statusCode, context: context);
  }
}
