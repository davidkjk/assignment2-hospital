...
MESSAGES = {
    ...
    # 4단계 챗봇: 직원이 상담 답변을 달면 알린다(내용은 넣지 않는다 — 문자에 상담 원문 노출 금지).
    # 토글은 support_reply(patient_notification_prefs_service). 익명 웹상담도 같은 문구를 쓴다.
    "support_answered": "상담하신 문의에 답변이 도착했습니다. 확인해 주세요.",
}
